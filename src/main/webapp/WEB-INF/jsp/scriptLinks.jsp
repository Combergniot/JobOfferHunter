...
<!--Local js file with tables configuration-->
<script type="text/javascript" src="/resources/js/tables.js"></script>
<script type="text/javascript" src="/resources/js/reportCaret.js"></script>
